...
let handler = async function (m, { conn, text, args, usedPrefix, command }) {
    ...
    let perfil = await conn.profilePictureUrl(whe, 'image').catch(_ => 'https://qu.ax/znlhs.jpg')
...
⤷ ${sn}`;
    ...
    let channelID = '120363420463070478@newsletter';
...
handler.help = ['reg']
handler.tags = ['rg']
handler.command = ['verify', 'verificar', 'r', 'reg', 'register', 'registrar']
